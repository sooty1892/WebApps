...
for (var i  in data){
    ...
    section += '<div id="starButton_'+sectionName+'"  class="starbtn unlitStar"></div><div id="uploadButton" class ="fileinput-button"><form method="post" enctype="multipart/form-data" action="scripts/upload_files.php"><input id ="' + i + '" onchange="uploadSongsToSection()" type="file" multiple></form></div></ul>';
